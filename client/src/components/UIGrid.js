...
import itemData from '../helpers/UIGrid';
...
export default function UIGrid({newImgData, setSrc}) {
        ...
        <div className={newImgData ? classes.hidden : classes.root}>
            <GridList cellHeight={300} className={classes.gridList} cols={4}>
                <GridListTile key="Subheader" cols={4} style={{ height: "auto"}}>
                    <ListSubheader className={classes.header} component="h3">Default UI Elements</ListSubheader>
                </GridListTile>
